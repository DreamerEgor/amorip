...
namespace OSImGui
{
	...
	public:
		...
		// Attach directly to a known top-level window. This avoids brittle class/title lookups.
		void AttachWindowHandle(HWND DestWindowHandle, std::function<void()> CallBack);
	private:
		void MainLoop();
